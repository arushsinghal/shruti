        ...
        <div className="px-6 py-3 bg-slate-50/70 border-b border-slate-100 flex flex-wrap gap-x-4 gap-y-2 items-center">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-medium text-primary hover:text-primary-dark border border-primary/25 hover:border-primary/50 bg-white hover:bg-primary/[0.04] rounded-lg px-3 py-1.5 transition-all"
            >
      ...
      {fhirData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[80vh] flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="p-6 overflow-y-auto flex-grow bg-slate-950 text-slate-200 font-mono text-xs leading-relaxed">
